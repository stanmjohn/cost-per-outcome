...
// and gets the committed brief back exactly. This test is that stranger.
...
import { build } from "../bin/cost-per-outcome.mjs";
...
for (const f of files) {
  test(`${f} rebuilds its committed brief exactly`, () => {
